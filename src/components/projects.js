    ...
    if(this.state.activeTab === 0){
      return(
        <div className="projects-grid">
          ...
          <Card shadow={5} style={{minWidth: '450', margin: 'auto'}}>
            <CardTitle style={{color: '#fff', height: '176px', background: 'url(https://www.surrealcms.com/uploads/nodejs-logo.png) center / cover'}} >Weather Forecast</CardTitle>
            <CardText>
          ...
          {/* Node Project 2 */}
          <Card shadow={5} style={{minWidth: '450', margin: 'auto'}}>
            <CardTitle style={{color: '#fff', height: '176px', background: 'url(https://www.surrealcms.com/uploads/nodejs-logo.png) center / cover'}} >Student Record System</CardTitle>
            <CardText>
          ...
          {/* Node Project 3 */}
          <Card shadow={5} style={{minWidth: '450', margin: 'auto'}}>
            <CardTitle style={{color: '#fff', height: '176px', background: 'url(https://www.surrealcms.com/uploads/nodejs-logo.png) center / cover'}}>Food Tracker</CardTitle>
            <CardText>
      ...
      return(
        <div className="projects-grid">
          {/* React Project 1 */}
          <Card shadow={5} style={{minWidth: '450', margin: 'auto'}}>
            <CardTitle style={{color: '#fff', height: '176px', background: 'url(https://xtnotes-1255646395.coshk.myqcloud.com/images/react-1.svg) center / cover'}} >Restaurent reactApp</CardTitle>
            <CardText>
          ...
          {/* React Project 2 */}
          <Card shadow={5} style={{minWidth: '450', margin: 'auto'}}>
            <CardTitle style={{color: '#fff', height: '176px', background: 'url(https://xtnotes-1255646395.coshk.myqcloud.com/images/react-1.svg) center / cover'}} >Personal portfolio</CardTitle>
            <CardText>
      ...
      return(
        <div className="projects-grid">
          {/* PHP Project 1 */}
          <Card shadow={5} style={{minWidth: '450', margin: 'auto'}}>
            <CardTitle style={{ height: '176px', background: 'url(https://www.php.net/images/logos/new-php-logo.svg) center / cover'}} >Hiring Website</CardTitle>
            <CardText>
          ...
          {/* PHP Project 2 */}
          <Card shadow={5} style={{minWidth: '450', margin: 'auto'}}>
            <CardTitle style={{height: '176px', background: 'url(https://www.php.net/images/logos/new-php-logo.svg) center / cover'}} >Sales Web</CardTitle>
            <CardText>
          ...
          {/* PHP Project 3 */}
          <Card shadow={5} style={{minWidth: '450', margin: 'auto'}}>
            <CardTitle style={{height: '176px', background: 'url(https://www.php.net/images/logos/new-php-logo.svg) center / cover'}} >Visit Nepal</CardTitle>
            <CardText>
      ...
      return(
        <div className="projects-grid">
          {/* JAVA Project 1 */}
          <Card shadow={5} style={{minWidth: '450', margin: 'auto'}}>
            <CardTitle style={{color: '#fff', height: '176px', background: 'url(https://twilio-cms-prod.s3.amazonaws.com/original_images/java-logo-wide.jpg) center / cover'}} >Parking Management System</CardTitle>
            <CardText>
          ...
          {/* JAVA Project 2 */}
          <Card shadow={5} style={{minWidth: '450', margin: 'auto'}}>
            <CardTitle style={{color: '#fff', height: '176px', background: 'url(https://twilio-cms-prod.s3.amazonaws.com/original_images/java-logo-wide.jpg) center / cover'}} >Hangman Game</CardTitle>
            <CardText>
